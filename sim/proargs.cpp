...
namespace sim {
     ...
     * @return Si el numero de argumentos es el adecuado se devuelve SUCCESS (0) en caso contrario ARGS_ERR (-1)
     */
     ...
     * @return Se devuelve ARGS_ERR (-1) si el time step indicado no es numerico, TIME_STEP_ERR (-2) si es menor
     * o igual a 0 y SUCCESS(0) en caso de exito
     */
     ...
     * @return Si no se puede abrir el archivo inicial se devuelve INIT_FILE_ERR (-3), si no se puede abrir
     * el archivo final se devuelve FINAL_FILE_ERR (-4) y SUCCESS (0) en caso de exito
     */
